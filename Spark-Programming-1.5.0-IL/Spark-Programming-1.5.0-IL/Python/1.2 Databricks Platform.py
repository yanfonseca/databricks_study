...
# MAGIC USING parquet 
# MAGIC OPTIONS (path "/mnt/training/ecommerce/events/events.parquet");
...
# MAGIC %fs ls /mnt/training/ecommerce
...
# MAGIC USING PARQUET
# MAGIC OPTIONS (path="/mnt/training/ecommerce/users/users.parquet")
...
# MAGIC USING PARQUET
# MAGIC OPTIONS (path="/mnt/training/ecommerce/sales/sales.parquet")
...
# MAGIC USING PARQUET
# MAGIC OPTIONS (path="/mnt/training/ecommerce/products/products.parquet")
...
teste = spark.sql('SELECT AVG(purchase_revenue_in_usd) FROM sales')
