...
budgetDF.createOrReplaceGlobalTempView('teste')
...
# TODO
eventsDF = spark.sql('SELECT * FROM events')
...
# TODO
macSQLDF = spark.sql("SELECT * FROM events WHERE device = 'macOS' ORDER BY event_timestamp ASC")
