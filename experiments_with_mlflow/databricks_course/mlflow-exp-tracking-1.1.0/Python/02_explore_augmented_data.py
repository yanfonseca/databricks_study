...
health_tracker_augmented_df.info()
...
#regularization - dados precisam estar na mesma escala, para linear regression
...
for i, feature in enumerate(features_numerical):
  ...
  feature_scaled = (feature - feature.mean())/feature.std()
