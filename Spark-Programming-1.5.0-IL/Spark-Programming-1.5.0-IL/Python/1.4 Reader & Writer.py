...
# TODO
userDefinedSchema = StructType([StructField('item_id', StringType() , True), 
...
# TODO
DDLSchema = 'item_id STRING, name STRING, price integer'
...
productsDF.write.mode('overwrite').save(productsOutputPath)
