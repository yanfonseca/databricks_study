...
health_tracker_data_2020_3_df.display()
...
spark.read.format('delta').load(health_tracker + "processed").display()
...
spark.read.format('delta').load(health_tracker + "processed").select('device_type').distinct().display()
